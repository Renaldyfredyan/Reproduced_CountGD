...
val_label_list = [
    'apple', 'candy piece', 'carrom board piece', 'cashew nut', 'comic book',
    'crab cake', 'deer', 'egg', 'elephant', 'finger food', 'green pea',
    'hot air balloon', 'keyboard key', 'lego', 'marble', 'marker',
    'nail polish', 'potato chip', 'red bean', 'round dessert', 'sauce bottle',
    'sea shell', 'sheep', 'ski', 'stamp', 'sticky note', 'strawberry',
    'sunglasses', 'tree log', 'watch', 'yellow lego stud'
]
